...
public class IndicatorsDAO {
  ...
  public List<String> getAllPosts() {
    ...
    String queryString = "select distinct " + Indicators.COLUMN_POST + " from "
            + Indicators.INDICATORS_TABLE + " order by " + Indicators.COLUMN_POST + " asc";
  ...
  public List<String> getAllSectors() {
    ...
    String queryString = "select distinct " + Indicators.COLUMN_SECTOR + " from "
            + Indicators.INDICATORS_TABLE + " order by " + Indicators.COLUMN_SECTOR + " asc";
    Cursor returnData = readDatabase.rawQuery(queryString, null);
  ...
  public List<String> getAllProjectsForPost(String post) {
    ...
    String queryString = "select distinct " + Indicators.COLUMN_PROJECT + " from "
            + Indicators.INDICATORS_TABLE + " where " + Indicators.COLUMN_POST + " = '" + post
  ...
  public List<Indicators> getAllIndicatorsForPostAndProject(String post, String project) {
    ...
    String whereClause = Indicators.COLUMN_POST + " = '" + post + "' and "
            + Indicators.COLUMN_PROJECT + " = '" + project + "'";
    String orderByClause = Indicators.COLUMN_GOAL + ", " + Indicators.COLUMN_OBJECTIVE + ", "
            + Indicators.COLUMN_TYPE + " desc"; // outputs BEFORE outcomes
    Cursor returnData = readDatabase.query(Indicators.INDICATORS_TABLE, columnsToRead, whereClause,
