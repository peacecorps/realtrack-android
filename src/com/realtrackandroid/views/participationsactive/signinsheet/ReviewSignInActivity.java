...
public class ReviewSignInActivity extends SherlockFragmentActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    List<Participant> currentParticipantList = resultBundle
            .getParcelableArrayList("participantList");
  ...
  public void onResume() {
    ...
    ReviewSigninSheetListAdapter listAdapter = new ReviewSigninSheetListAdapter(this,
            R.layout.row_reviewsigninparticipants, participantList);
