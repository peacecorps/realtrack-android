...
public class RequiredFragment extends SherlockFragment {
  ...
  private RecordParticipationFragmentInterface mActivity;
  ...
  public void onAttach(Activity activity) {
      ...
      try {
        mActivity = (RecordParticipationFragmentInterface) activity;
  ...
  public boolean setFields(Participation p){
    ...
    if (!men09Checkbox.isChecked() && !men1017Checkbox.isChecked() && !men1824Checkbox.isChecked()
      ...
      Toast.makeText(getActivity(), R.string.emptyfieldserrormessage,
    ...
    try {
      ...
      Toast.makeText(getActivity(), R.string.emptyfieldserrormessage, Toast.LENGTH_SHORT).show();
      return false;
    }
