...
public class NotificationReceiver extends BroadcastReceiver {
    ...
    for (Reminders r : reminders_data) {
      ...
      for (Participation p : participation_data) {
        ...
        if (Calendar.getInstance().compareTo(unservicedCalendar) == -1) {
          ...
          deleteParticipationAndAlarm(context, pDao, p.getId());
        }
      }
  ...
  private static void deleteParticipationAndAlarm(Context context, ParticipationDAO pDao,
          int participationId) {
  ...
  private static void deleteReminderAndAlarm(Context context, RemindersDAO rDao, int reminderId) {
