...
public class AllActivitiesActivity extends SherlockActivity {
    ...
    void filteractivitiesList(String text) {
        ...
        listAdapter = new ActivitiesListAdapter(AllActivitiesActivity.this, R.layout.row_allactivities, filteredactivities_data);
     ...
     * list style defined in layout/row_allactivities.xmlxml
    ...
    void updateActivitiesList() {
        ...
        listAdapter = new ActivitiesListAdapter(this, R.layout.row_allactivities, activities_data);
