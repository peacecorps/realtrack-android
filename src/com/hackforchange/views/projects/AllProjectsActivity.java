...
public class AllProjectsActivity extends SherlockActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_allprojects);
    }
    ...
    void filterprojectsList(String text) {
        ...
        listAdapter = new ProjectListAdapter(AllProjectsActivity.this, R.layout.row_allprojects, filteredprojects_data);
     ...
     * list style defined in layout/allprojectslist_rowrow.xml
    ...
    void updateProjectsList() {
        ...
        listAdapter = new ProjectListAdapter(this, R.layout.row_allprojects, projects_data);
